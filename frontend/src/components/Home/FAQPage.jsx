  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Following the legal marriage age in India, the minimum age to register on Satfera is 20 years for women and 21 years for men. This ensures all our members are eligible for marriage as per Indian law.",
      },
      {
        id: "reg-3",
        question:
          "Can my parents or family members create a profile on my behalf?",
        answer:
          "Absolutely! We understand that in Indian culture, finding a life partner is often a family effort. Profiles can be created by yourself, your parents (for son or daughter), siblings (for brother or sister), or even close friends. We encourage family involvement as it reflects the traditional values we cherish.",
      },
      {
        id: "reg-4",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "When you accept someone's request and they've also accepted yours, it becomes a mutual match! These mutual matches appear in your 'Approved' section. Our admin team steps in to coordinate between both families. The admin will contact both parties and help arrange meetings based on everyone's convenience - whether that's a phone call, video call, or in-person meeting.",
      },
      {
        id: "conn-4",
        question: "Why can't I directly contact other users?",
        answer:
          "At Satfera, your privacy and safety are paramount. Unlike other platforms where your phone number and personal details might be visible to strangers, we keep all contact information strictly confidential. Only our admin team can see these details. When there's a mutual match, our admin acts as a trusted intermediary to coordinate between families - just like a traditional family matchmaker would.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "We take your privacy very seriously! Your contact details (phone number, email, address) are never visible to other users - only our admin team can access them for verification and coordination. Your ID proof photo is hidden from other users and used only for verification purposes. You can upload up to 5 profile photos - these are visible to other members, but your ID documents remain confidential. All communication happens through our secure admin coordination system.",
      },
      {
        id: "safety-2",
    ...
    questions: [
      {
        ...
        answer:
          "We're here to help! You can reach our support team in multiple ways: Through your Dashboard - Go to Settings > Help & Support > Contact Support to chat with our admin team directly. By raising a Ticket - Go to Settings > Help & Support > Your Tickets > Create New Ticket. Select a category (General, Billing, etc.), describe your issue, and submit. You can also find our contact details on the homepage of our website.",
      },
      {
        id: "help-2",
        question: "How long does it take to get a response from support?",
        answer:
          "Our dedicated support team strives to respond to all queries as quickly as possible. For tickets raised through the dashboard, you can expect a response within 24-48 hours. Urgent matters related to billing or account access are prioritized. You can check the status of your ticket anytime in Settings > Help & Support > Your Tickets. We appreciate your patience and are committed to resolving your concerns!",
      },
      {
        id: "help-3",
        question: "Where can I find the Terms & Privacy Policy?",
        answer:
          "You can access our complete Terms of Service and Privacy Policy by going to Settings > Help & Support > Terms & Privacy Policy. We encourage all members to read these documents to understand how we operate and protect your information. If you have any questions about our policies, please don't hesitate to contact our support team.",
      },
    ],
  },
  {
...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-beige w-full overflow-x-hidden">
      <SEO
        title="Satfera FAQs | Matrimony Questions Answered"
        description="Common questions about Satfera’s matrimony services and features."
        path="/faq"
        schema={{
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "Is Satfera free?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Satfera offers both free and premium membership plans.",
              },
            },
          ],
        }}
      ...
      {/* Contact Section */}
      <div className="py-16 px-4" style={{ backgroundColor: colors.planBg }}>
